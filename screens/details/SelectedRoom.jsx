...
import { AssetsImage, Counter, HeightSpacer, NetworkImage, ReusableBtn, ReusableText, WidthSpacer } from "../../components";
...
<View style={reusable.rowWithSpace("flex-start")}>
    <AssetsImage mode={'contain'} width={40} height={20}
    source={require('../../assets/images/visapng.png')}
    />
